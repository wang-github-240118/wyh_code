...
a = r'C:\Users\Lenovo\Desktop\新的校核\图像\全部汇总\tif.txt'
b = r'C:\Users\Lenovo\Desktop\新的校核\图像\全部汇总\tif——all.txt'
...
with open(b, 'w', encoding='utf-8') as file2:
    for line in sorted_lines:
        ...
        # 原有写入格式（各字段空格分隔，换行）
        file2.write(f'{NAC} {Shadow} {NAC_binary_image} {Shadow_binary_image} {XOR}_{xor2} {EXCEL}\n')
